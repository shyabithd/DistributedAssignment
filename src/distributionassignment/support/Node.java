...
import distributionassignment.communication.BSCommunicationManager;
import distributionassignment.communication.NeighbourCommunicationManager;
import distributionassignment.communication.Sender;
...
public class Node {
    ...
    public void rateFile(String fileNameToRate, String fileRate) {
        fileSearch.rateFile(fileNameToRate, fileRate);
    }
    
    public void fileComment(String fileNameToRate, String comment) {
        fileSearch.fileComment(fileNameToRate, comment);
    }
